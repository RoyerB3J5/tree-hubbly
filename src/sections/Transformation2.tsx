      ...
      <section className="w-full flex justify-center items-center bg-primary">
        <div className="w-full max-w-screen xl:max-w-7xl px-5 xl:px-0 flex flex-col justify-center items-center gap-8 md:gap-11 lg:gap-14 pt-10 md:pt-20 lg:pt-30">
          <div className="flex flex-col justify-center items-center gap-8">
            ...
            />
            <p
              className="text-paragraph text-p-mobile md:text-p-desktop font-normal leading-[150%] text-center animation-zoom-in"
          ...
          <div className="w-full flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6">
            {content.lists.map((list, index) => (
              <div
                ...
                /* He reemplazado 'border' por 'border-transparent' en tus clases para que no rompa la máscara del efecto */
                className={`${list.border || ""} w-full md:w-1/2 flex flex-col justify-start lg:justify-center items-start gap-8 py-8 md:py-14 px-4 md:px-12 rounded-2xl md:rounded-3xl border-transparent box-border back-content self-stretch animation-zoom-in`}
              >
                <div className="flex justify-start items-center gap-6 md:gap-4">
                  <img
